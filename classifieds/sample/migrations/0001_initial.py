# Generated by Django 3.0.3 on 2020-03-01 20:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audience', models.CharField(choices=[('STUDENT', 'Student'), ('FACULTY', 'Faculty'), ('STAFF', 'Staff')], max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('role', models.CharField(choices=[('STUDENT', 'Student'), ('FACULTY', 'Faculty'), ('STAFF', 'Staff')], max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='RidePosting',
